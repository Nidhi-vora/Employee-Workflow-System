...
<li <?php if($page_name == "upload" ){echo "class=\"active\"";} ?>><a href="upload.php">event<span style="font-size:16px; color:#d4ab3a;" class="pull-right hidden-xs showopacity glyphicon glyphicon-calendar"></span></a></li>
