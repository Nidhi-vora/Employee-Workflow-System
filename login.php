    	...
    	<div class="container">
    		<div class="row no-gutters d-flex align-items-center align-items-stretch">
    			<div class="col-md-4 d-flex align-items-center py-4">
    				<a class="navbar-brand" href="index.html">Employee workflow system</a>
    			</div>
      ...
      <div class="container">
        ...
        <div class="row block-9 justify-content-center mb-5">
          <div class="col-md-8 mb-md-5">
              ...
              <br><input type="submit"  class="btn btn-primary py-3 px-5" name="login">
              <a href="registration.php" class="nav-link">Registeration</a> 
